...
#Удалить строку из матрицы по индексу
    try:
        row_index = int(input("Введите индекс строки для удаления: "))
...
def main():
    ...
    while True:
        ...
        print("3. Удалить столбец")
        print("4. Транспонировать матрицу")
        print("5. Удалить главную диагональ")
        print("6. Удалить побочную диагональ")
        print("7. Заменить строку случайной строкой")
        print("8. Заменить столбец из другой матрицы")
        print("9. Найти кратный элемент и обнулить строку")
        print("10. Вычислить детерминант квадратной матрицы")
        print("11. Перемножить 2 матрицы")
        print("12. Поменять местами две строки матрицы.")
        print("0. Выход")
        ...
        if choice == "1":
            ...
            multiply_matrices()
        elif choice == "12" and matrix is not None:
